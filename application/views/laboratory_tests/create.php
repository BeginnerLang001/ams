                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="ultrasound" class="form-control" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="pregnancy_test" class="form-label">Pregnancy Test Result:</label>
                                <input type="text" name="pregnancy_test" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="urinalysis" class="form-control" required>
                            </div>
