                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover" id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                // Helper function to mark duplicate times
                                function isDuplicate($dateTime, $appointmentTimes) {
                                    return in_array($dateTime, $appointmentTimes);
                                }
                                ...
                                foreach ($appointments as $appointment):
                                    ...
                                    <tr class="<?= $highlightClass; ?>">
                                        ...
                                        <td>Walk-In</td>
                                        <td>
                                            <span class="badge <?= $appointment['status'] === 'approved' ? 'bg-success' : 'bg-warning text-dark'; ?>">
                                ...
                                <?php foreach ($onlineappointments as $onlineappointment):
                                    ...
                                    if ($status !== 'cancelled' && $status !== 'completed'):
                                        ...
                                        <tr class="<?= $highlightClass; ?>">
                                            ...
                                            <td>Online</td>
                                            <td>
                                                <span class="badge <?= $status === 'booked' ? 'bg-success' : 'bg-warning text-dark'; ?>">
                                                    <?= ucfirst($status); ?>
                                                </span>
                                            </td>
                                            <td>
                        ...
                        <!-- Export buttons -->
                        <!-- <a href="<?php echo site_url('ExportController/all_csv'); ?>" class="btn btn-primary">Export All Appointments CSV</a>
                        <a href="<?php echo site_url('ExportController/all_excel'); ?>" class="btn btn-success">Export All Appointments Excel</a> -->
                    </div>
