                        ...
                        <tbody>
                            <?php foreach ($registrations as $registration): ?>
                                <tr>
                                    ...
                                    <!-- <td><?= $registration->philhealth_id ?></td>
                                    <td><?= $registration->no_of_pregnancy ?></td>
                                    <td><?= $registration->last_menstrual ?></td>
                                    <td><?= $registration->age_gestation ?></td>
                                    <td><?= $registration->expected_date_confinement ?></td> -->
                                    <td>
                                        ...
                                        <!-- <a href="<?php echo site_url('registration/delete/' . $registration->id); ?>" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><i class="fas fa-trash"></i></a> -->
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
